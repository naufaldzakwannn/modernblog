...
export default function Footer() {
  return (
    <footer id="about" className="border-t border-ink/10 px-6 py-16 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
        {/* Brand */}
        <div className="md:col-span-4 space-y-4">
          <h2 className="font-display text-4xl font-bold">FOLIO</h2>
          <p className="font-body text-sm text-ink/55 leading-relaxed max-w-xs">
            An independent editorial publication exploring the intersections of design, 
        ...
        <div className="md:col-span-4 flex flex-col justify-end">
          <div className="font-display text-[80px] font-bold text-ink/5 leading-none text-right select-none">
            IDEAS
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mt-12 pt-6 border-t border-ink/10 gap-4">
        ...
        <p className="font-mono text-[10px] tracking-widest uppercase text-ink/20">
